...
class AppointmentListMobileView extends StatefulWidget {
  final String doctorId;
  final Map<String, dynamic> userData;

  const AppointmentListMobileView({
    super.key,
  ...
  @override
  State<AppointmentListMobileView> createState() =>
      _AppointmentListMobileViewState();
}

class _AppointmentListMobileViewState extends State<AppointmentListMobileView> {
