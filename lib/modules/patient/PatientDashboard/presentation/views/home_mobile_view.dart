...
class PatientHomeMobileView extends StatefulWidget {
  final Map<String, dynamic> userData;

  const PatientHomeMobileView({super.key, required this.userData});

  @override
  State<PatientHomeMobileView> createState() => _PatientHomeMobileViewState();
}

class _PatientHomeMobileViewState extends State<PatientHomeMobileView> {
              ...
              child: GradientButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AppointmentBookingMobileView(
        ...
        ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return Center(
              child: SizedBox(
                width:
                    isDesktop ? 600 : MediaQuery.of(context).size.width * 0.95,
                child: _buildDoctorDetailCard(doctor),
              ),
            );
          },
